    ...
    if depth_compatible:
        ...
        if display_kf_prediction:
            if str(type(target_3d_kinematic_state)) != str(type(None)):
                ...
                image.add_text(text=f"target_3d_state: A {target_3d_kinematic_state[6]:.2f}, {target_3d_kinematic_state[7]}:2f, {target_3d_kinematic_state[8]}:2f",  location=(x_location, y_location)); y_location += 50
            else:
