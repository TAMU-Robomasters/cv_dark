...
- Mac/Linux users
    ...
    - Type this inside your terminal/console <br>`repo=git@github.com:TAMU-Robomasters/cv_dark.git setup_or_copy=setup eval "$(curl -fsSL git.io/JE2Zm || wget -qO- git.io/JE2Zm)"`<br>[press enter]
    - Possible errors:
